...
// Tenta alternar o status
if ($curso->toggleStatus($id_curso)) {
    $_SESSION['msg_curso'] = "Status do curso alterado com sucesso!";
    $_SESSION['tipo_msg_curso'] = 'sucesso';
} else {
    $_SESSION['msg_curso'] = "Erro ao alterar status do curso.";
    $_SESSION['tipo_msg_curso'] = 'erro';
}
